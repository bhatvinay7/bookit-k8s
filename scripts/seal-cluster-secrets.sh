...
required=(
  DATABASE_URL REPLICATION_URL MONGO_DB_URL REDIS_URL RABBITMQ_URL
...
seal bookit-secrets sealed-platform-secrets.yaml \
  --from-literal=CLOUDFLARE_ACCOUNT_ID="$CLOUDFLARE_R2_ACCOUNT_ID" \
  --from-literal=CLOUDFLARE_R2_ACCESS_KEY="$CLOUDFLARE_R2_ACCESS_KEY_ID" \
